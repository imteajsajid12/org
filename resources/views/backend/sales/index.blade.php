                ...
                <div class="card-header row  gutters-5 ">
                    <div class="group_button float-right">
                        <div class="form-group mb-0 " style="display: flex">
                            ...
                            <form id="destination-form2" class="mr-1" action="{{route('courier.pathao')}}">
                                <!-- Appended checkboxes will appear here -->
                                <button type="submit" id="submit-btn" class="btn  btn-sm " style="background-color: #e83330; color: #FFFFFF"><i class="fa fa-truck"></i> {{ translate('Pathao') }}  e.`</button>
                            </form>
                            <form id="destination-form3" class="mr-1" action="{{route('courier.redx')}}">
                                <!-- Appended checkboxes will appear here -->
                            ...
                            <form id="destination-form1" class="mr-1" action="{{route('courier.steadfast')}}" method="POST">
                                @csrf
                                <!-- Appended checkboxes will appear here -->
                                <button type="submit" id="submit-btn1" class="btn btn-success btn-sm pr-1"><i class="fa fa-truck"></i> {{ translate('Stead Fast') }}  </button>
                            </form>
                                    ...
                                    <div class="form-group">
                                        <div class="aiz-checkbox-inline">
                                            <label class="aiz-checkbox">
                                                <input type="checkbox" id="select-all" class="check-all">
                                    ...
                                    <td>
                                        ...
                                        <div class="form-group">
                                            <div class="aiz-checkbox-inline">
                                                ...
                                                <label class="aiz-checkbox">
                                                    <input type="checkbox" class="source-checkbox" name="id[]"
                                                           value="{{ $order->id }}">
                                                    <span class="aiz-square-check"></span>
                                                    <i>{{$order->id}}</i>
                                                </label>
